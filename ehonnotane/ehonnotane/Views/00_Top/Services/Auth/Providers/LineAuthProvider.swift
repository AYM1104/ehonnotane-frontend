...
//             .audience(audience)
//             .parameters(["connection": "line"]) // LINEプロバイダーを指定
...
//                         self?.errorMessage = "LINEログアウトに失敗しました: \(error.localizedDescription)"
...
//             var userFriendlyMessage = "LINEログインに失敗しました"
...
//                 5. LINE Developersで作成したChannel IDとChannel Secretを設定
                
//                 詳細は開発者にお問い合わせください。
//                 """
//                 print("❌ LINEログインエラー: Auth0でLINE接続が有効になっていません")
//                 print("   解決方法: Auth0ダッシュボードでLINE接続を有効化してください")
//             } else {
//                 userFriendlyMessage = "LINEログインに失敗しました: \(errorDescription)"
//             }
